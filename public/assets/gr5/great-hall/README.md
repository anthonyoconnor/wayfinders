# Great Hall presentation assets

This directory contains the fixed project assets used by the view-only Great
Hall workspace and shared game renderer:
...
in the approved graphical composition. The shared renderer does not display lineage
totals.
